...
window.MATES = {
  ...
  /* ------------------------------------------------------------------
     ...
     VŠECHNY příspěvky jsou na stránce vsechny-prispevky.html — dostaneš
  ...
  /* ------------------------------------------------------------------
     AKTUÁLNÍ ZADÁNÍ — stránka aktualni-zadani.html
     ------------------------------------------------------------------
  ...
  /* ------------------------------------------------------------------
     O SOUTĚŽI — stránka o-soutezi.html
     ------------------------------------------------------------------
